...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, required=True) # "original" or "refined"
    ...
    if args.dataset == "original":
        # original dataset with 13 output classes
    ...
    elif args.dataset == "refined":
        # refined dataset with 6 output classes
        ...
        raise ValueError("--dataset argument must be either 'original' or 'refined'")
